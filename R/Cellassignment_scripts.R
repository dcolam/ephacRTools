...
#' Assign cell colors to your wells based on the imaging data
#' @param SE Your SummarizedExperiment
...
#' @export
# plot_well_assignment <- function(SE, color_col = "Color_manual", title = NULL, colors = c("red" = "red", "green" = "green", "yellow" = "yellow", "black" = "grey")) {
